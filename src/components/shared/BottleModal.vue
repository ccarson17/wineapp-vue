<template>
    <div>
        <div v-if="selectedBottle" class="modal fade" :id="'bottleDetailsModal' + index" tabindex="-1" aria-labelledby="bottleDetailsModalLabel" aria-hidden="true">
                                ...
                                <tr>
                                    <td>
                                        <span style="margin: 0px">
                                            {{ locationFilter(selectedBottle.city_Town, selectedBottle.state_Province, selectedBottle.region, selectedBottle.country) }}
                                        </span>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <table style="text-align: left; width: 100%">
                            <tr>
                                ...
                                <td v-if="selectedBottle.abv !== '%'">
                                    <b>ABV:</b> {{ percentFilter(selectedBottle.abv) }}
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                            ...
                            <tr v-if="selectedBottle.price_paid">
                                <td>
                                    <b>Price:</b> {{ currencyFilter(selectedBottle.price_paid, "$") }}
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    <b>Added date:</b> {{ dateFormat(selectedBottle.created_date) }}
                                </td>
                            </tr>
                            <tr v-if="modalType == 'history'">
                                <td colspan="2">
                                    <b>Drink date:</b> {{ dateFormat(selectedBottle.drink_date) }}
                                </td>
                            </tr>
                            ...
                            <tr v-if="selectedBottle.user_rating">
                                <td colspan="2">
                                    ...
                                    <img src="@/assets/baseline_star_border_black_48dp_full.png" width="24" height="24" v-if="parseInt(selectedBottle.user_rating) == 10">
                                </td>
                            </tr>
                        </table>
                    </div>
                    <div class="modal-footer bg-default text-default" style="align-items: center">
                        <table style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td style="width: 50%">
                                    <button type="button" class="btn btn-primary" style="width: 95%" v-if="modalType != 'history'" data-bs-toggle="modal" :data-bs-target="'#locateModal' + index">
        ...
        <LocateModal :id="'locateModal' + index" :index="index" :bottle="selectedBottle" :key="selectedBottle && selectedBottle.guid ? selectedBottle.guid : 'empty'" />
        <RatingModal :index="index" :bottle="selectedBottle" @update="handleBottleUpdate" />
    </div>
</template>
        ...
        methods: {
            ...
            async handleBottleUpdate(updatedBottle) {
                ...
                try {
                    ...
                    // Refresh bottles and reset selectedBottle
                    await this.$store.dispatch('getCurrentBottles');
                    this.$emit('clear-selected-bottle');
